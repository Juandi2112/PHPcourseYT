...
<body>
    ...
    <form action="ejercicio31.php" method="post">
        ...
        <br /> html: <input type="radio" <?php echo ($rdgLenguaje == "html") ? "checked" : ""; ?> name="lenguaje" value="html" id="html"><br />
        <br /> css: <input type="radio" <?php echo ($rdgLenguaje == "css") ? "checked" : ""; ?> name="lenguaje" value="css" id="css"><br />
        <br />
        ...
        <select name="lsAnime" id="">
            ...
            <option value="avatar" <?php echo ($lsAnime == "avatar") ? "selected" : ""; ?>>Avatar</option>
            <option value="dragon" <?php echo ($lsAnime == "dragon") ? "selected" : ""; ?>>Dragon Ball</option>
        </select>
        </br>

        ¿Tienes alguna duda?...</br>
        <textarea name="txtComentario" id="" cols="" rows=""></textarea>
        </br>
